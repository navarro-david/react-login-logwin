        ...
        <div className={styles.card}>
            <div className={styles.card_column_form}>
                ...
                <form className={styles.card_form} autoComplete="off">
                    ...
                    <fieldset
                        ...
                        style={
                            isValidated ? { opacity: "1" } : { opacity: "0" }
                        }
                    >
                        <legend>SSN</legend>
                        <input
            ...
            <div className={styles.card_column_content}>
                <h1>
                    ...
                    <span
                        className={
                            formSubmitted ? styles.effect_scary_text : ""
                        }
                    >
                        forever.
                    </span>
                ...
                <p>
                    We aim to ease the pain of remembering countless passwords
                    and credentials. Let us carry that burden. Simply provide us
                    with a little information about yourself and we will do the
                    work for you.
                </p>
                <p>Trust us.</p>
                <h3
